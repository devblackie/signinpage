...
const Signup = ({ handleLogin }) => {
  ...
  const { setUserName } = useUser(); // Ret
  const [redirectToHome, setRedirectToHome] = useState(false);  //Automatic redirect
      ...
      <div className="form-container">
        {submissionStatus === "success" ? (
          <div className="success">
            <h1> <span className="text-capitalize"> {name}</span> successfully registered!!</h1>
